 ...
 */
class PartialFileException extends CurlException implements DetailedExceptionInterface {
    ...
    public function getDetailedMessage() {
        return 'A file transfer was shorter or larger than expected. This ' .
        'happens when the server first reports an expected transfer size, and then delivers ' .
