 ...
 */
class FtpPortFailedException extends CurlException implements DetailedExceptionInterface {
    ...
    public function getDetailedMessage() {
        return 'The FTP PORT command returned error. This mostly happens when you haven\'t specified ' .
