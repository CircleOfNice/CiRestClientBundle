 ...
 */
class FileCouldntReadFileException extends CurlException implements DetailedExceptionInterface {
    ...
    public function getDetailedMessage() {
        return 'A file given with FILE:// couldn\'t be opened. Most likely because the file path doesn\'t ' .
        'identify an existing file. Did you check file permissions?';
    }
}