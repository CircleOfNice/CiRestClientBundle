 ...
 */
class OutOfMemoryException extends CurlException implements DetailedExceptionInterface {
    ...
    public function getDetailedMessage() {
        return 'A memory allocation request failed. This is serious badness and things are severely ' .
