 ...
 */
class HttpReturnedErrorException extends CurlException implements DetailedExceptionInterface {
    ...
    public function getDetailedMessage() {
        return 'When sending custom "QUOTE" commands to the remote server, one of the commands ' .
        'returned an error code that was 400 or higher (for FTP) or otherwise indicated unsuccessful ' .
