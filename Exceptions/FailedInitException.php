...
class FailedInitException extends CurlException implements DetailedExceptionInterface {
    ...
    public function getDetailedMessage() {
        return 'Very early initialization code failed. This is likely to be an internal error ' .
        'or problem, or a resource problem where something fundamental couldn\'t get done at init time.';
    }
}