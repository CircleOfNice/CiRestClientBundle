 ...
 */
class UnknownOptionException extends CurlException implements DetailedExceptionInterface {
    ...
    public function getDetailedMessage() {
        return 'An option passed to libcurl is not recognized/known. Refer to the appropriate documentation. ' .
        'This is most likely a problem in the program that uses libcurl. The error buffer might contain more ' .
